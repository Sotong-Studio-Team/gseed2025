...
{
    public interface IEnemyCardSelectionController
    {
        void SelectCardAction(IActionCard actionCard);
    }

    public class EnemyCardSelectionController : IEnemyCardSelectionController
    {
        ...
        public EnemyCardSelectionController(IActionProcessor actionProcessor, 
        ...
        {
            var lastExecutedResult = _battleCardDataService.GetEnemyActionResult();
            ...
            _battleCardSelectionDataServiceUpdate.SetEnemyLastActionResult(newActionResult);
